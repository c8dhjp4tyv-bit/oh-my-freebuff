...
/**
 * advisor-a — one voice in the omf-advisor panel (model A).
 *
 * advisor-a/b/c are identical in behavior but pinned to DIFFERENT models (see
 * models.json panel-a/b/c tiers) so the panel reflects genuinely different
 * reasoning. omf-advisor spawns all three and synthesizes their answers.
 */
const advisorA: AgentDefinition = {
  id: 'advisor-a',
  displayName: 'OMF Advisor A',
  model: 'z-ai/glm-4.7',
